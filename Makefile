...
OBJS := main.o ext2.o net.o shell.o entry.o boot_init.o \
		...
		syscalls/syscalls.o syscalls/syscall_functions/process_basics.o syscalls/syscall_functions/io.o syscalls/syscall_functions/sys_signals.o syscalls/syscall_functions/unix_socket.o syscalls/syscall_functions/kernel.o \
		tasks/task.o\
