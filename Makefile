...
$(DISK_FILE):
	...
	i=1; \
	BUSY_BOX_PROGRAMS="ash cat chmod cp date dd df echo hostname kill ln ls mkdir mv ps pwd rm rmdir sleep login hexdump sed sort su tail head tar time whoami vi w wall wc xxd xargs xz users uniq uname less stty find cryptpw";\
